...
def filter_alignment(infile, threshold, coverage_d):
	if threshold < 1:
		...
		print("NOTE: --threshold lower than 1.0, scaling to percentage!", threshold)
	outfile = infile.split(".")[0] + "_passed.fasta"
...
For optimal performance on alignments, use trimmed data!""")
